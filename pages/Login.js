...
const Login = ({ onToggleAuth, userType, onLogin }) => {
    ...
    return html`
        <div class="min-h-screen bg-white flex flex-col md:flex-row overflow-hidden">
            ...
            <!-- Mobile Image Header -->
            <div class="md:hidden h-48 relative">
                <img src="assets/hero-bg.png" alt="Bloom Studio" class="absolute inset-0 w-full h-full object-cover" />
                <div class="absolute inset-0 bg-bloom-purple/30"></div>
            </div>
            ...
            <div class="flex-1 flex items-center justify-center p-8 md:p-20 bg-bloom-offWhite">
                <div class="max-w-md w-full">
                    ...
                    <div class="mt-16 pt-8 border-t border-bloom-gray/20 text-center">
                        <div class="flex items-center justify-center gap-2 mb-4">
                            <span class="font-serif text-xl font-bold text-bloom-purple tracking-widest uppercase">Bloom</span>
                        </div>
                        <p class="text-[9px] uppercase tracking-[0.3em] text-bloom-graphite/30 font-bold">Desenvolvido com sofisticação</p>
                    </div>
                </div>
            </div>
        </div>
